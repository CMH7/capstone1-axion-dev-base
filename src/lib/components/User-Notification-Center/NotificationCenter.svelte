...
<div
  class="overflow-x-hidden has-transition z-100 pos-fix p-2 pos-t-65 pos-r-{outerWidth < 426? '0': '20'} maxmins-w-300-dt-to-mb-100p bg-color-pastel-white-card {!$notifCenterOpen? 'scale-0': 'scale-1'} rounded elevation-4" style="min-height: {!$notifCenterOpen? '0px': '580px'}; max-height: {!$notifCenterOpen? '0px': '580px'};"
>
